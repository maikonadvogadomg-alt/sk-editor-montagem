...
export default function SystemStatusPanel({ open, onClose, vfs, projectName }: Props) {
  ...
  const runChecks = useCallback(async () => {
    ...
    // 6. Terminal Linux real (PTY via WebSocket)
    items.push({
      id: "term",
      label: "Terminal em uso",
      status: "ok",
      detail: "🐧 Terminal Linux real (PTY via WebSocket) — bash de verdade, npm install funciona",
