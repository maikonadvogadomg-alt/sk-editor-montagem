...
`);
            const neonUrl = args[1] || "";
            const dbUrl = neonUrl.startsWith("postgresql://") || neonUrl.startsWith("postgres://")
              ? neonUrl
              : "postgresql://usuario:senha@ep-xxxx.region.aws.neon.tech/neondb?sslmode=require";
            const urlIsReal = dbUrl !== "postgresql://usuario:senha@ep-xxxx.region.aws.neon.tech/neondb?sslmode=require";
...
`);
            if (urlIsReal) {
              addLine("success", "✓ Template Neon criado com sua connection string real!");
              addLines("info", [
              ...
              addLines("info", [
                "  Proximos passos:",
                "  1. Acesse: console.neon.tech e crie conta gratuita",
                "  2. Crie um projeto e copie a Connection String",
                "  3. Cole a URL direto no comando: db neon <SUA_URL>",
                "     Ex: db neon postgresql://user:pass@ep-xxx.neon.tech/db?sslmode=require",
                "  Ou abra o .env e substitua a URL placeholder pela real",
                "",
